import '../registered_meansnoides_screen/widgets/l1radio1_item_widget.dart';
import '../registered_meansnoides_screen/widgets/userprofile4_item_widget.dart';
...
class RegisteredMeansnoidesScreen
    extends GetWidget<RegisteredMeansnoidesController> {
  const RegisteredMeansnoidesScreen({Key? key})
      : super(
          key: key,
        );
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSensorInputColumn(),
                        SizedBox(height: 29.v),
                        _buildClientNameInputColumn(),
                        SizedBox(height: 29.v),
                        _buildPositionInputColumn(),
  ...
  /// Section Widget
  Widget _buildVectorDropdownRow() {
    return Row(
      ...
      children: [
        ...
        CustomDropDown(
          ...
          hintText: "lbl_de".tr,
          items: controller
              .registeredMeansnoidesModelObj.value.dropdownItemList!.value,
          prefix: Container(
  ...
  /// Section Widget
  Widget _buildSensorInputColumn() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          "lbl_sensor_number".tr,
  ...
  /// Section Widget
  Widget _buildClientNameInputColumn() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  /// Section Widget
  Widget _buildPositionInputColumn() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
                        ...
                        child: Obx(
                          () => Row(
                            children: [
                              CustomRadioButton(
                                text: "lbl_l1".tr,
                                value: controller.registeredMeansnoidesModelObj
                  ...
                  () => Column(
                    children: [
                      Padding(
                        ...
                        child: CustomRadioButton(
                          text: "lbl_50ma".tr,
                          value: controller.registeredMeansnoidesModelObj.value
                              .radioList1.value[2],
        ...
        children: [
          Obx(
            () => CarouselSlider.builder(
              ...
              itemCount: controller.registeredMeansnoidesModelObj.value
            ...
            child: Obx(
              () => Container(
                ...
                child: AnimatedSmoothIndicator(
                  ...
                  count: controller.registeredMeansnoidesModelObj.value
                      .userprofile4ItemList.value.length,
                ...
                Container(
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.registeredMeansnoidesModelObj.value
                          .l1radio1ItemList.value.length,
                      itemBuilder: (context, index) {
                        L1radio1ItemModel model = controller
                            .registeredMeansnoidesModelObj
                            .value
                            .l1radio1ItemList
                            .value[index];
                        return L1radio1ItemWidget(
                          model,
                        );
                      },
                    ),
                    ...
                    children: [
                      Padding(
                        ...
                        child: CustomRadioButton(
                          ...
                          value: controller.registeredMeansnoidesModelObj.value
                              .radioList10.value[1],
                          groupValue: controller.radioGroup10.value,
                          padding: EdgeInsets.only(
                            left: 8.h,
                            right: 24.h,
                          ),
                          onChange: (value) {
                            controller.radioGroup10.value = value;
                          },
                        ),
                      ),
                      Padding(
  ...
  /// Section Widget
  Widget _buildKitchenMeasnodeColumn() {
    return Container(
      width: 350.h,
      padding: EdgeInsets.symmetric(
        horizontal: 15.h,
