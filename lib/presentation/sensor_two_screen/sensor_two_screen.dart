import '../sensor_two_screen/widgets/radio1_item_widget.dart';
import '../sensor_two_screen/widgets/radiooption2_item_widget.dart';
import '../sensor_two_screen/widgets/userprofile1_item_widget.dart';
...
class SensorTwoScreen extends GetWidget<SensorTwoController> {
  const SensorTwoScreen({Key? key}) : super(key: key);
      ...
      CustomDropDown(
          ...
          icon: Container(
              ...
              child: CustomImageView(
                  ...
                  width: 24.adaptSize)),
          hintText: "lbl_de".tr,
          items: controller.sensorTwoModelObj.value.dropdownItemList!.value,
          prefix: Container(
              ...
              child: Column(children: [
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => Row(children: [
                                    CustomRadioButton(
                                        text: "lbl_l1".tr,
                                        value: controller.sensorTwoModelObj
                ...
                Container(
                    ...
                    child: Obx(() => ListView.separated(
                        ...
                        itemCount: controller.sensorTwoModelObj.value
                            .radiooption2ItemList.value.length,
                        itemBuilder: (context, index) {
                          Radiooption2ItemModel model = controller
                              .sensorTwoModelObj
                              .value
                              .radiooption2ItemList
                              .value[index];
                          return Radiooption2ItemWidget(model);
                        })))
              ]))),
      Container(
          margin: EdgeInsets.symmetric(horizontal: 5.h),
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList2.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList2.value[3],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList2.value[4],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList4.value[1],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList4.value[2],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList4.value[3],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              }))
        ...
        child: Stack(alignment: Alignment.topRight, children: [
          Obx(() => CarouselSlider.builder(
              ...
              itemCount: controller
                  .sensorTwoModelObj.value.userprofile1ItemList.value.length,
              itemBuilder: (context, index, realIndex) {
                Userprofile1ItemModel model = controller
                    .sensorTwoModelObj.value.userprofile1ItemList.value[index];
          ...
          Align(
              ...
              child: Obx(() => Container(
                  ...
                  child: AnimatedSmoothIndicator(
                      ...
                      count: controller.sensorTwoModelObj.value
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller.sensorTwoModelObj.value
                                      .radio1ItemList.value.length,
                                  itemBuilder: (context, index) {
                                    Radio1ItemModel model = controller
                                        .sensorTwoModelObj
                                        .value
                                        .radio1ItemList
                                        .value[index];
                                    return Radio1ItemWidget(model);
                                  })))
                        ]))
              ]))),
      Container(
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList7.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList7.value[3],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList7.value[4],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList9.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList9.value[3],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorTwoModelObj.value.radioList9.value[4],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              }))
  ...
  /// Navigates to the sensorThreeScreen when the action is triggered.
  onTapBtnLineSystemAddLine() {
    Get.toNamed(
      AppRoutes.sensorThreeScreen,
    );
  }
}
