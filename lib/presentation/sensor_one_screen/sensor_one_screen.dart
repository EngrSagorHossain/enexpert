import '../sensor_one_screen/widgets/radio3_item_widget.dart';
import '../sensor_one_screen/widgets/radiooption4_item_widget.dart';
import '../sensor_one_screen/widgets/sensorcomponent_item_widget.dart';
...
class SensorOneScreen extends GetWidget<SensorOneController> {
  const SensorOneScreen({Key? key}) : super(key: key);
      ...
      CustomDropDown(
          ...
          icon: Container(
              ...
              child: CustomImageView(
                  ...
                  width: 24.adaptSize)),
          hintText: "lbl_de".tr,
          items: controller.sensorOneModelObj.value.dropdownItemList!.value,
          prefix: Container(
              ...
              child: Column(children: [
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => Row(children: [
                                    CustomRadioButton(
                                        text: "lbl_l1".tr,
                                        value: controller.sensorOneModelObj
                ...
                Container(
                    ...
                    child: Obx(() => ListView.separated(
                        ...
                        itemCount: controller.sensorOneModelObj.value
                            .radiooption4ItemList.value.length,
                        itemBuilder: (context, index) {
                          Radiooption4ItemModel model = controller
                              .sensorOneModelObj
                              .value
                              .radiooption4ItemList
                              .value[index];
                          return Radiooption4ItemWidget(model);
                        })))
              ]))),
      Container(
          margin: EdgeInsets.symmetric(horizontal: 5.h),
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList2.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList2.value[3],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList2.value[4],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList4.value[1],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList4.value[2],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList4.value[3],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              }))
        ...
        child: Stack(alignment: Alignment.topRight, children: [
          Obx(() => CarouselSlider.builder(
              ...
              itemCount: controller
                  .sensorOneModelObj.value.sensorcomponentItemList.value.length,
              itemBuilder: (context, index, realIndex) {
                SensorcomponentItemModel model = controller.sensorOneModelObj
                    .value.sensorcomponentItemList.value[index];
                return SensorcomponentItemWidget(model,
                    onTapBtnLineSystemAddLine: () {
                  onTapBtnLineSystemAddLine();
                });
              })),
          Align(
              ...
              child: Obx(() => Container(
                  ...
                  child: AnimatedSmoothIndicator(
                      ...
                      count: controller.sensorOneModelObj.value
                          .sensorcomponentItemList.value.length,
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller.sensorOneModelObj.value
                                      .radio3ItemList.value.length,
                                  itemBuilder: (context, index) {
                                    Radio3ItemModel model = controller
                                        .sensorOneModelObj
                                        .value
                                        .radio3ItemList
                                        .value[index];
                                    return Radio3ItemWidget(model);
                                  })))
                        ]))
              ]))),
      Container(
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList7.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList7.value[3],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList7.value[4],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList9.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList9.value[3],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorOneModelObj.value.radioList9.value[4],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              }))
  ...
  /// Navigates to the sensorScreen when the action is triggered.
  onTapBtnLineSystemAddLine() {
    Get.toNamed(
