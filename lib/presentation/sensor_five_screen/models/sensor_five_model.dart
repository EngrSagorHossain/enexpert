...
import 'radiooption6_item_model.dart';
import 'userprofile3_item_model.dart';
import 'radio5_item_model.dart';
import '../../../core/app_export.dart';

/// This class defines the variables used in the [sensor_five_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class SensorFiveModel {
  ...
  Rx<List<Radiooption6ItemModel>> radiooption6ItemList =
      Rx(List.generate(1, (index) => Radiooption6ItemModel()));
  ...
  Rx<List<Radio5ItemModel>> radio5ItemList =
      Rx(List.generate(1, (index) => Radio5ItemModel()));
