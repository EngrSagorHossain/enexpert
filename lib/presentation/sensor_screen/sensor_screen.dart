import '../sensor_screen/widgets/radio4_item_widget.dart';
import '../sensor_screen/widgets/radiooption5_item_widget.dart';
import '../sensor_screen/widgets/sensorcomponent1_item_widget.dart';
...
class SensorScreen extends GetWidget<SensorController> {
      ...
      CustomDropDown(
          ...
          icon: Container(
              ...
              child: CustomImageView(
                  ...
                  width: 24.adaptSize)),
          hintText: "lbl_de".tr,
          items: controller.sensorModelObj.value.dropdownItemList!.value,
          prefix: Container(
                ...
                Container(
                    ...
                    child: Obx(() => ListView.separated(
                        ...
                        itemCount: controller.sensorModelObj.value
                            .radiooption5ItemList.value.length,
                        itemBuilder: (context, index) {
                          Radiooption5ItemModel model = controller
                              .sensorModelObj
                              .value
                              .radiooption5ItemList
                              .value[index];
                          return Radiooption5ItemWidget(model);
                        })))
              ]))),
      Container(
          margin: EdgeInsets.symmetric(horizontal: 5.h),
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList2.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList2.value[3],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList2.value[4],
                              groupValue: controller.radioGroup2.value,
                              onChange: (value) {
                                controller.radioGroup2.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList4.value[1],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList4.value[2],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList4.value[3],
                              groupValue: controller.radioGroup4.value,
                              onChange: (value) {
                                controller.radioGroup4.value = value;
                              }))
        ...
        child: Stack(alignment: Alignment.topRight, children: [
          Obx(() => CarouselSlider.builder(
              ...
              itemCount: controller
                  .sensorModelObj.value.sensorcomponent1ItemList.value.length,
              itemBuilder: (context, index, realIndex) {
                Sensorcomponent1ItemModel model = controller
                    .sensorModelObj.value.sensorcomponent1ItemList.value[index];
                return Sensorcomponent1ItemWidget(model);
              })),
          Align(
              ...
              child: Obx(() => Container(
                  ...
                  child: AnimatedSmoothIndicator(
                      ...
                      count: controller.sensorModelObj.value
                          .sensorcomponent1ItemList.value.length,
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller.sensorModelObj.value
                                      .radio4ItemList.value.length,
                                  itemBuilder: (context, index) {
                                    Radio4ItemModel model = controller
                                        .sensorModelObj
                                        .value
                                        .radio4ItemList
                                        .value[index];
                                    return Radio4ItemWidget(model);
                                  })))
                        ]))
              ]))),
      Container(
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList7.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList7.value[3],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList7.value[4],
                              groupValue: controller.radioGroup7.value,
                              onChange: (value) {
                                controller.radioGroup7.value = value;
                              }))
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList9.value[2],
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_100ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList9.value[3],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              })),
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_300ma".tr,
                              value: controller
                                  .sensorModelObj.value.radioList9.value[4],
                              groupValue: controller.radioGroup9.value,
                              onChange: (value) {
                                controller.radioGroup9.value = value;
                              }))
  ...
  /// Navigates to the sensorFiveScreen when the action is triggered.
  onTapIN3() {
    Get.toNamed(
      AppRoutes.sensorFiveScreen,
    );
  }
}
