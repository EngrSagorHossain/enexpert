import '../sensor_three_screen/widgets/radio2_item_widget.dart';
import '../sensor_three_screen/widgets/radiooption3_item_widget.dart';
import '../sensor_three_screen/widgets/userprofile2_item_widget.dart';
...
class SensorThreeScreen extends GetWidget<SensorThreeController> {
  const SensorThreeScreen({Key? key}) : super(key: key);
      ...
      CustomDropDown(
          ...
          icon: Container(
              ...
              child: CustomImageView(
                  ...
                  width: 24.adaptSize)),
          hintText: "lbl_de".tr,
          items: controller.sensorThreeModelObj.value.dropdownItemList!.value,
          prefix: Container(
              ...
              child: Column(children: [
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => Row(children: [
                                    CustomRadioButton(
                                        text: "lbl_l1".tr,
                                        value: controller.sensorThreeModelObj
                ...
                Container(
                    ...
                    child: Obx(() => ListView.separated(
                        ...
                        itemCount: controller.sensorThreeModelObj.value
                            .radiooption3ItemList.value.length,
                        itemBuilder: (context, index) {
                          Radiooption3ItemModel model = controller
                              .sensorThreeModelObj
                              .value
                              .radiooption3ItemList
                              .value[index];
                          return Radiooption3ItemWidget(model);
                        })))
              ]))),
      Container(
          margin: EdgeInsets.symmetric(horizontal: 5.h),
              ...
              child: Column(children: [
                ...
                Obx(() => Column(children: [
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_50ma".tr,
                              value: controller.sensorThreeModelObj.value
                                  .radioList2.value[2],
        ...
        child: Stack(alignment: Alignment.topRight, children: [
          Obx(() => CarouselSlider.builder(
              ...
              itemCount: controller
                  .sensorThreeModelObj.value.userprofile2ItemList.value.length,
              itemBuilder: (context, index, realIndex) {
                Userprofile2ItemModel model = controller.sensorThreeModelObj
          ...
          Align(
              ...
              child: Obx(() => Container(
                  ...
                  child: AnimatedSmoothIndicator(
                      ...
                      count: controller.sensorThreeModelObj.value
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller.sensorThreeModelObj
                                      .value.radio2ItemList.value.length,
                                  itemBuilder: (context, index) {
                                    Radio2ItemModel model = controller
                                        .sensorThreeModelObj
                                        .value
                                        .radio2ItemList
                                        .value[index];
                                    return Radio2ItemWidget(model);
                                  })))
                        ]))
              ]))),
      Container(
  ...
  /// Navigates to the sensorOneScreen when the action is triggered.
  onTapIN2() {
    Get.toNamed(
      AppRoutes.sensorOneScreen,
    );
  }
}
